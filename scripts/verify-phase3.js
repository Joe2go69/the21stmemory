...
const stubSample = path.join(ROOT, 'dive', 'breakdown', 'resonating-army.html');
...
check('sitemap no stub resonating-army', !sm.includes('/dive/breakdown/resonating-army.html'));
