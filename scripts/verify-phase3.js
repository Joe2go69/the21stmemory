...
const stubSample = path.join(ROOT, 'dive', 'breakdown', 'vatican-archive.html');
...
check('sitemap no stub vatican-archive', !sm.includes('/dive/breakdown/vatican-archive.html'));
