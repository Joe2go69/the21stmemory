module.exports = {
  ...
  images: {
    topic: { source: 'Reunion Mechanics.webp', target: 'reunion-mechanics.webp' },
    pdfPreview: { source: 'Cosmic_Homecoming_Mechanics.webp', target: 'cosmic-homecoming-mechanics.webp' },
    infographic: {
      source: 'Reunion_Mechanics_Homecoming_Guide.webp',
      target: 'reunion-mechanics-homecoming-guide.webp'
    }
  },
  slide_deck_pdf_url:
    'https://drive.google.com/file/d/1ZmBEoLzrURVbFNreOm-2-2MahHUcIW5s/view?usp=sharing',
  rumble_videos: [
    {
      title: 'Physical mechanics of our cosmic extraction',
      embed_url: 'https://rumble.com/embed/v7cntik/?pub=4p0ieu',
      description:
    ...
    {
      title: 'The Mechanics of Homecoming',
      embed_url: 'https://rumble.com/embed/v7cntqs/?pub=4p0ieu',
      description:
...
## Key Terminology
- **Sol Frequency Lock** — The activation of a unique personal recognition code known only to a soul's kin, aligning their energetic signature to the pick-up frequency.
- **The Homecoming** — The direct, amnesia-free path of exit from the known lands to reunite with solar parents, twin flames, and original star families.
- **Vibrational Alignment** — The frequency threshold where a soul's consciousness matches the higher realms, allowing transition through the sacred gate.
- **Heart Pull** — An immediate physical sensation of profound calm and reassurance felt in the chest of resonating souls during the arrival of the true light fleets.
- **Frequency Lock** — A protective energetic containment applied to a returning soul's vessel to block any last-minute interference from the 3D matrix net during departure.
- **Resonance Bridge** — The direct, non-healing pathway of ascension used by the already-awakened Resonating Army to immediately exit the physical plane.
- **Saferons** — Radiant, benevolent, tall holographic light beings sent from the Council of 12 Suns to guide and stabilize transitional souls.
...
### The Triggering of Dormant Codes
...
### The Physiological Shift and Atmospheric Reset
...
### The Frequency Lock and Matrix Isolation
...
### The Seamless Phase Out and Solar Gate Transition
...
### The Routing of Souls and Sanctuaries
...
- **Water Domes** — Shimmering, invisible domes projected over crystalline waters that vibrate like liquid sound, drawing out emotional density and mending the heart.
- **Crystal Halls** — Crystalline temples overlaid by 3D structures (such as cathedrals or abbeys) where souls rest on humming crystal slabs to clear mind control, mental overlays, and restore memory streams.
- **Star Pods** — Floating pods in etheric space where fragmented aspects of the soul are rewoven across timelines to heal deep karmic and timeline trauma.
