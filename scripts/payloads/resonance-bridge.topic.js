module.exports = {
  ...
  images: {
    topic: { source: 'Resonance Bridge.webp', target: 'resonance-bridge.webp' },
    pdfPreview: { source: 'The_Resonance_Bridge.webp', target: 'the-resonance-bridge.webp' },
    infographic: {
      source: 'Homecoming__Activate_Resonance_Bridge.webp',
      target: 'homecoming-activate-resonance-bridge.webp'
    }
  },
  slide_deck_pdf_url:
    'https://drive.google.com/file/d/13hv5-wLydOO2tNuv-69nG8CzkSonN6fb/view?usp=sharing',
  rumble_videos: [
    {
      title: 'The Resonance Bridge',
      embed_url: 'https://rumble.com/embed/v7cnq54/?pub=4p0ieu',
      description:
        'The Resonance Bridge — Direct homecoming path for the Resonating Army to phase out of the Cube by frequency match.'
    },
    {
      title: 'Exiting the Cube via the Resonance Bridge',
      embed_url: 'https://rumble.com/embed/v7cnqo8/?pub=4p0ieu',
      description:
...
## Key Terminology
- **Resonance Bridge** — The direct, non-healing homecoming pathway that allows highly aligned souls to exit the simulated reality of the KNOWN LANDS and return directly to their original realms of origin without undergoing transitional healing processes.
- **Resonating Army** — The returning starseed or ET souls who entered the simulated physical plane with dormant-active frequency codes, destined to awaken and guide others before exiting via the homecoming path.
- **Homecoming Path** — The direct, sanctuary-bypassing transition route utilized exclusively by the Resonating Army to reunite with their original solar families and worlds.
- **Frequency Threshold** — A non-physical resonance point where an individual's consciousness vibration matches the precise octaves of the higher realms, enabling exit from the dome.
- **Axis Labernum** — The primary vertical current of order that acts as a harmonic bridge, linking the crystalline grids of the earth to the stellar node networks in the upper layers.
- **Crystalline Bridge** — A visual frequency mirror (such as a rainbow) that manifests when the atmospheric layers of the overlapping domes align and refract multi-dimensional light.
- **Sol Frequency Lock** — A highly personal recognition code, unique to an individual's spiritual kin, which activates during the final lift to initiate a seamless phase-out.
...
### The Mechanics of the Frequency Phase-Out
...
### Sanctuary Bypass and Vibrational Distinctions
...
- **Water Domes** — Vast shimmering, pearlescent domes projected over crystalline waters that vibrate like liquid sound. These draw out emotional density and replace it with harmonic resonance to mend deep grief, fear, and heartbreak.
- **Crystal Halls** — Living temples of crystal where souls rest on humming crystal slabs. Light passing through crystal prisms realigns the light body grid and dissolves mind control overlays and mental damage.
- **Star Pods** — Etheric cocoons suspended in space, resembling nebulae, where streams of light frequency reweave fragmented aspects of the soul across multiple timelines of trauma.
...
### The Axis Labernum as a Structural Conduit
...
### Crystalline Overlays and Rainbow Frequency Mirrors
