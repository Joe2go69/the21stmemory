module.exports = {
  ...
  images: {
    topic: { source: 'Titanic Op.webp', target: 'titanic-op.webp' },
    pdfPreview: { source: 'The_Titanic_Crystalline_Op.webp', target: 'the-titanic-crystalline-op.webp' },
    infographic: {
      source: 'The_Titanic_Op__Great_Remembering.webp',
      target: 'the-titanic-op-great-remembering.webp'
    }
  },
  slide_deck_pdf_url:
    'https://drive.google.com/file/d/1wRlI6RGeH2gGGsHZFO-SMBMFKMyn_0Il/view?usp=sharing',
  rumble_videos: [
    {
      title: 'Titanic Heist for Atlantian Power Nodes',
      embed_url: 'https://rumble.com/embed/v7cep7k/?pub=4p0ieu',
      description:
    ...
    {
      title: 'The 1912 Titanic Op',
      embed_url: 'https://rumble.com/embed/v7cepkw/?pub=4p0ieu',
      description:
...
- **Titanic Op** — The multi-dimensional sabotage and false-flag operation in 1912 designed to eliminate banking opposition, harvest mass emotional trauma, and confiscate ancient technologies.
- **Federal Reserve** — The central, debt-based banking system established in 1913 by the parasitic cabal following the strategic assassination of its wealthiest opponents.
- **Keel Splitting** — The precise physical mechanism of structural destruction executed by undersea directed energy weapons to split the luxury liner's hull plating.
- **Atlantian Power Nodes** — Ancient crystalline generator fragments capable of anchoring free-energy grids and transmitting high-vibrational Source frequencies.
- **Tartarian Templar Tools** — Frequency-encoded metallic instruments, such as specialized tuning forks and rods, used to amplify and direct planetary leyline currents.
- **Saturnian Cube Tech** — The artificial intelligence network running on Saturn's frequency, which utilized salvaged Atlantian crystal technology to manage the planetary reincarnation loops and memory suppression.
- **Frozen Holography** — A high-density projection technology utilized to overlay physical matter or empty space with the visual and sensory appearance of solid ice, acting as camouflage for tactical assets.
- **Cabal Submersibles** — Advanced underwater vessels utilizing stolen resonant coil designs to operate silently at extreme depths for salvage and military enforcement.
...
### The Sinking Mechanism: Undersea Directed Energy Weaponry
...
### The Illusion of Icebergs: Frozen Holography
...
### The Hidden Cargo: Ancient Technology and Forbidden Manuscripts
...
- **Crystalline Power Nodes:** At least two smaller fragments cut from a massive Atlantian generator stone. These stones were highly resonant conductors of free energy and were being smuggled to the United States to assist Nikola Tesla and his circle of colleagues in constructing a global wireless power grid.
- **Sacred Egyptian Manuscripts:** Ancient scrolls and texts detailing the precise physics of sound-light creation and the geometric engineering of crystalline lattices.
- **Tartarian Leyline Amplifiers:** Refined metallic relics, including specialized tuning forks and rods recovered from sealed Tartarian vaults in Europe, designed to harmonize and amplify the earth's natural currents.

### The Post-Sinking Retrieval Operation
...
- One Atlantian generator fragment was integrated into the development of Saturnian Cube Tech, cementing the parasitic A.I. black cube network.
- The second crystal fragment was transported to Switzerland and locked within the deep Rothschild vault system, where its suppressed pulse continues to trigger dream-state memories in sensitive individuals.
- A third piece was intercepted by a non-cabal breakaway faction of Tartarian survivors (the lost sols of Tara), remaining hidden and completely shielded from parasite scans.
- The sacred scrolls were split; some were sequestered in the Vatican Hidden Libraries, while others were distributed to private masonic lodges to be used in secretive initiation rites.
- The Tartarian templar tools were reverse-engineered into crude frequency weapons, which the cabal subsequently deployed to dismantle the remaining outposts of old-world architecture.
