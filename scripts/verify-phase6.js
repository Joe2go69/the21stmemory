...
(function phase3() {
  ...
  const stub = 'dive/breakdown/code-dissolution.html';
  ...
  check(g, 'sitemap excludes stub', !sm.includes('/dive/breakdown/code-dissolution.html'));
...
(function phase5() {
  ...
  const stub = read('dive/breakdown/code-dissolution.html');
