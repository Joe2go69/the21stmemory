...
(function phase3() {
  ...
  const stub = 'dive/breakdown/homecoming-path.html';
  ...
  check(g, 'sitemap excludes stub', !sm.includes('/dive/breakdown/homecoming-path.html'));
...
(function phase5() {
  ...
  const stub = read('dive/breakdown/homecoming-path.html');
