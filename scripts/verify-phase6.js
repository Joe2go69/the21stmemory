...
(function phase3() {
  ...
  const stub = 'dive/breakdown/vatican-archive.html';
  ...
  check(g, 'sitemap excludes stub', !sm.includes('/dive/breakdown/vatican-archive.html'));
...
(function phase5() {
  ...
  const stub = read('dive/breakdown/vatican-archive.html');
