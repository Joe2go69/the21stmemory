...
(function phase3() {
  ...
  const stub = 'dive/breakdown/et-sols.html';
  ...
  check(g, 'sitemap excludes stub', !sm.includes('/dive/breakdown/et-sols.html'));
...
(function phase5() {
  ...
  const stub = read('dive/breakdown/et-sols.html');
